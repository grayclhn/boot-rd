...
confidence intervals for the RD treatment effects may be biased can have
...
with the second order polynomical converges to zero at a faster rate, fast
...
polynomial is the true Data Generating Process (DGP), its estimate of the
...
underlying bootstrap algorithm, are the subject of ongoing research.
