...
\begin{abstract}\noindent
  ...
  \textit{Econometrica}) analytical correction. This paper also provides
  simulation evidence that our method is as accurate as the analytical
  corrections and we demonstrate its use through a reanalysis of Ludwig and
  Miller's (2008) Head Start dataset.
\end{abstract}
...
by~\cite{ludwig2007}.\footnote{%
  ...
  \textit{doParallel} \citep{doparallel}, \textit{foreach} \citep{foreach}, and
...
original results in \cite{ludwig2007}.\footnote{%
  ...
  triangular and uniform kernel were essentially the same, and this discrepency
